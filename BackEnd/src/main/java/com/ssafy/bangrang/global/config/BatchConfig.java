...
public class BatchConfig {
    ...
    @Bean
    public Job firstJob() {
        System.out.println("First Job 수행중...");
    ...
    public Step taskletStep() {
        System.out.println("First Step 수행중...");
    ...
    public Step chunkStep() {
        System.out.println("chunk step 수행중...");
        return new StepBuilder("first step", jobRepository)
