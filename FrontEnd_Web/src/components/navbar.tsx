        ...
        <header className="navbar">
          ...
          {!IsMobile ? (
            <div className={styles.navbtn_lst}>
              ...
              <button className={`${styles.navbtn} ${styles.appdown}`} onClick={()=>{window.open("https://drive.google.com/file/d/1KMYMEKm2dlUduvbeXbHentJ3ic6hg06r/view", '_blank')}}>다운로드</button>
              {/* <Link
            ...
            <div className={styles.dropdown}>
              ...
              {isDropDown && (
                <div className={styles.dropdown_content}>
                  ...
                  <a href="https://drive.google.com/file/d/1KMYMEKm2dlUduvbeXbHentJ3ic6hg06r/view">다운로드</a>
                </div>
              )}
            </div>
          )}
